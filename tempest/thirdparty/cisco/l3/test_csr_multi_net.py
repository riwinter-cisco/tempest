...
class TestCSRMultiNet(manager.NetworkScenarioTest):

    @classmethod
    def check_preconditions(cls):
        super(TestCSRMultiNet, cls).check_preconditions()
    ...
    def setUpClass(cls):
        ...
        super(TestCSRMultiNet, cls).setUpClass()
    ...
    def setUp(self):
        super(TestCSRMultiNet, self).setUp()
